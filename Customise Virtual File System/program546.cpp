...
void DisplayHelp()
{
    ...
    printf("man     : it is use to Display manuel page\n");
...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("About : It is used to display manuel page\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        iCount = sscanf(str,"%s %s %s %s %s", Command[0],Command[1],Command[2],Command[3]);
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thnak you for using Marvellous CVFS\n");
